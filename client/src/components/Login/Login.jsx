          ...
          <form className='space-y-6'>
            <div>
              ...
              <div className='mt-1 relative'>
                <input className='appearance-none block w-full px-3 py-2 border border-gray-500 rounded shadow-sm placeholder-slate-200 focus:outline-none focus:border-blue-300' type='password' name='password' autoComplete='current-password' required value={password} onChange={(e) => { setPassword(e.target.value) }}></input>
